...
const Projects = () => {
  return (
    ...
    <div className='projects-container'>
      ...
      <div>
        <div className="d-flex justify-content-between"><h3 className='d-inline'>Speakit Live</h3> <a href="https://github.com/jjmountain/speakit-live" target='_blank' rel="noopener noreferrer">[view on github]</a></div>
        <p>
        ...
        <div className='tech-pic-box'>
          ...
          <div class="embed-responsive embed-responsive-16by9">
            <iframe src="https://www.youtube.com/embed/PUKd0lOSe74" className='embed-responsive-item' allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          </div>
      </div>
    </div>
